...
def Menu() :
    ...
    while 1: #this asks the user what the want to do and makes sure the game doesnt brake if they dont put in an integer
...
def selWord(sel) :
    ...
    return word
#this is the list of words possible to guess for each level
animals=["tiger", "elephant", "bear", "dog", "cat", "cow"]
fruit=["banana", "strawberries","grape", "watermelon", "cantalope", "blueberries"]
...
print(sel)
while sel <=3 :
#this is giving the user directions for the game 
...
#this makes sure that the user has a certain amount of turns and controls the tries they have
...
#this saves our score to another file with the users name and score 
